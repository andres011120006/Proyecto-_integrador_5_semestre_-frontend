    ...
    return (
        <div>
            ...
            <div className="card-group">
                {/* Tarjeta 1: Registro de incidencias */}
                <div className="card">
                    <a href="/registroCon">
                        <img
                            src={card1}
                            className="card-img-top"
                            alt="Registro de incidencias en conglomerados forestales"
                        />
                    </a>
                ...
                {/* Tarjeta 2: Registro de individuos arbóreos */}
                <div className="card">
                    <a href="/registroArboreos">
                        <img
                            src={card2}
                            className="card-img-top"
                            alt="Registro de individuos arbóreos en inventario forestal"
                        />
                    </a>
                    <div className="card-body">
                ...
                {/* Tarjeta 4: Generación de reportes */}
                <div className="card">
                    <a href="/reporte">
                        <img
                            src={card4}
                            className="card-img-top"
                            alt="Generación de reportes del inventario forestal"
                        />
                    </a>
                    <div className="card-body">
